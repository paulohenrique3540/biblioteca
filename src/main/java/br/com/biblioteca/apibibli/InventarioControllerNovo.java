...
// Anotação que marca esta classe como um controlador Spring MVC, versão nova do controlador de inventário
@Controller
// Classe controladora nova para gerenciamento de inventário de livros, com fallback para dados mockados
public class InventarioControllerNovo {
    ...
    // Anotação que mapeia requisições GET para "/inventario-novo" a este método
    @GetMapping("/inventario-novo")
    // Método que exibe a página nova de controle de inventário
